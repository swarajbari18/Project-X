...
Businesses already use many different software products.

Some software helps manage customers.

Some software helps manage support tickets.

Some software helps manage jobs.

Some software helps manage invoices and payments.

Some software helps manage inventory.

Some software helps manage employees.

Each of these systems is built to solve a specific problem.
...
The answer may depend on information from the accounting software.

The same customer may then ask,

"When will my order arrive?"

The answer may depend on the operations software.

The customer does not know where this information is stored.

The customer expects the business to know.

Employees often become the bridge between these different systems.

They open one application.
...
They ask other employees.

They wait for replies.

Only after collecting enough information can they answer the customer.

This process is slow.

It also becomes difficult to repeat consistently.

Two employees may answer the same question differently.

One employee may know something that another employee does not.

One software may contain newer information than another.

Sometimes the information itself is incomplete.

Sometimes different systems disagree with each other.

Existing software usually assumes that someone already knows the complete situation.

In reality, understanding the situation is often the hardest part.

Finding the correct information is work.

Verifying that information is also work.
...
Imagine a customer sends the following message to a business.

> "Hi, I was told my order would arrive yesterday, but I still haven't received it. Can someone please tell me what's happening?"

To the customer, this is a simple question.

To the business, answering it may not be simple at all.

The business first needs to understand the situation.
...
Did the delivery partner report a problem?

Has another employee already spoken to the customer?

Did someone promise a new delivery date?

Has a refund already been approved?

The answer may exist in different places.

Some information may be available in business software.

Some information may only be known by an employee.

Some information may still be missing.

Instead of immediately writing a reply, Tend first understands what information is needed.

It then starts collecting that information.

If the information comes from business software, Tend retrieves it.

If the information comes from another employee, Tend asks the right person.

If different sources disagree, Tend highlights the conflict instead of choosing one at random.

If an important piece of information is missing, Tend waits until enough information is available.

Only after understanding the complete situation does Tend decide what should happen next.

Sometimes the next step is to reply to the customer.

Sometimes the next step is to ask another employee to take action.

Sometimes the next step is to update a business system.

Sometimes the next step is to inform the customer that the business is still investigating the issue.
...
From the customer's point of view, they simply receive a timely and helpful response.
...
They define how Tend should behave, no matter how the product evolves.
...
If the required information is missing, Tend should never invent an answer.

It should never pretend to know something that it does not know.

When the information is incomplete, Tend should clearly identify what is missing.

If necessary, it should ask the right person or the right system before continuing.
...
Whenever possible, Tend should use information from reliable sources instead of assumptions or interpretations.

If two sources disagree, Tend should identify the disagreement instead of hiding it.
...
If a decision can be made using clear rules, Tend should make that decision using the system itself.

Artificial intelligence should only be used when reasoning or understanding is actually required.

This makes the system easier to understand, easier to test and more reliable.
...
If Tend recommends an action, there should be a clear reason behind it.
...
The business should be able to see what happened.

It should be possible to understand what information was used.

It should be possible to understand what decisions were made.
...
Sometimes information will be missing.

Sometimes another system will fail.

Sometimes people will make mistakes.

When this happens, Tend should fail in a way that keeps the business safe.
...
Understanding what Tend is also requires understanding what Tend is not.

Tend is not trying to replace every piece of software that a business already uses.

Businesses already have accounting software.

They already have customer management software.

They already have inventory systems.

They already have scheduling systems.

They already have communication platforms.

These systems already solve important problems.

Tend is designed to work with them, not replace them.
...
The difficult part is understanding what is happening.

A perfectly written reply is still the wrong reply if it is based on incorrect information.
...
A CRM stores information about customers.

Tend uses customer information.

A CRM helps businesses record what they know.

Tend helps businesses use that knowledge while interacting with customers.
...
Workflow tools execute predefined steps.

Many business situations cannot be completely predefined.

Customers ask unexpected questions.

Employees make exceptions.

Business situations change.

Tend helps the business understand what is happening before deciding what action should be taken.

Sometimes the next step follows an existing workflow.

Sometimes the business needs to make a completely new decision.
...
People handle unusual situations.

People define business policies.
...
Some actions have significant business consequences.

Some situations require human judgement.

Some situations require approval.
...
Tend helps the business operate more effectively.

The business still owns its customers.

The business still owns its data.

The business still owns its policies.

The business still owns its decisions.

Tend provides assistance.

The responsibility for running the business always remains with the business itself.
